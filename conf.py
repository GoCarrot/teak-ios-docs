...
version = git_version.split("-")[0].encode("utf-8")
# The full version, including alpha/beta/rc tags.
release = git_version.encode("utf-8")
...
latex_documents = [
    (master_doc, 'TeakiOS.tex', u'Teak for iOS Documentation',
     u'Teak', 'manual'),
]
...
man_pages = [
    (master_doc, 'teakios', u'Teak for iOS Documentation',
     [author], 1)
]
